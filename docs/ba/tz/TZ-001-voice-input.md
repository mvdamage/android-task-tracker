...
- Статус: ready
- Дата: 2026-07-27
- Обновлено: 2026-07-27 — v1.1: парсинг даты/времени задачи; категории покупок
...
| Permission / disclaimer / listening / processing / error | Без изменений смысла относительно базового TZ | |
...
- [ ] Permission, disclaimer, ошибки STT
...
| 8 | Дата/время и категория из речи | нет | **In** (это обновление) |

---

**Статус `ready`.** История: 2026-07-27 — добавлены парсинг срока задачи и категории покупки по запросу стейкхолдера.
